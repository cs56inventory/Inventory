...
//
//public class oldClientInterface extends CleanJFrame {
...
////				this.setBounds(0, 0, 802, 474);
////				this.setBounds(580, 266, 100, 35);
...
//				loginP.add(btnLogin);
//				this.add(loginP, BorderLayout.CENTER);
//
////				this.add(lblLoginStatus);
////				this.add(lblConnectionStatus);
//				
